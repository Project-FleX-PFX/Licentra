...
DB.transaction(rollback: :reraise) do
  # Nur Rollen erstellen, wenn sie noch nicht existieren
  ...
  # Hier könnten weitere grundlegende Einstellungen erfolgen
  # z.B. Standard-Lizenztypen, wenn sie noch nicht existieren
